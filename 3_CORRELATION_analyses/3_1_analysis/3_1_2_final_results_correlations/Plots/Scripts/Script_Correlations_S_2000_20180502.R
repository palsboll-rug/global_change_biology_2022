...
#tiff("SouthernCorrelations_2000.tiff", width = 25, height = 25, units = 'cm', res = 300, compression = 'lzw')
...
#tiff("SouthernCorrelationsLowerNoLabels_2000.tiff", width = 11, height = 11, units = 'cm', res = 400, compression = 'lzw')
...
tiff("SouthernCorrelationsLowerLabels_2000.tiff", width = 18.3, height = 18.3, units = 'cm', res = 400, compression = 'lzw')
...
tiff("SouthernCorrelations_Sig_2000_NEW_NLabel.tiff", width = 18.3, height = 18.3, units = 'cm', res = 400, compression = 'lzw')
