...
#Read the file 
Antarctic.Data.LR<- read_csv("D:/RUG/Migration Antarctic/Correlations/Plots/Data/Southern_AllApprox_LR_5000_Mod_20180501.csv")
...
#tiff("SouthernCorrelations_5000.tiff", width = 25, height = 25, units = 'cm', res = 300, compression = 'lzw')
...
#tiff("SouthernCorrelationsLowerNoLabels_5000.tiff", width = 11, height = 11, units = 'cm', res = 400, compression = 'lzw')
...
tiff("SouthernCorrelationsLowerLabels_5000.tiff", width = 18.3, height = 18.3, units = 'cm', res = 400, compression = 'lzw')
...
tiff("SouthernCorrelations_Sig_5000_NEW_NLabel.tiff", width = 18.3, height = 18.3, units = 'cm', res = 400, compression = 'lzw')
