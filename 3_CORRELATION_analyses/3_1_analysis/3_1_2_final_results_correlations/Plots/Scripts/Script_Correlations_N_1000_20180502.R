...
#Read the file 
Arctic.Data.LR<- read_csv("D:/RUG/Migration Antarctic/Correlations/Plots/Data/Northern_AllApprox_LR_1000_Mod_20180502.csv")
...
#tiff("NorthernCorrelations_1000.tiff", width = 25, height = 25, units = 'cm', res = 300, compression = 'lzw')
...
#tiff("NorthernCorrelationsLowerNoLabels_1000.tiff", width = 18.3, height = 18.3, units = 'cm', res = 400, compression = 'lzw')
...
tiff("NorthernCorrelationsLowerLabels_1000.tiff", width = 18.3, height = 18.3, units = 'cm', res = 400, compression = 'lzw')
...
tiff("NorthernCorrelations_Sig_1000_NEW_NLabel.tiff", width = 18.3, height = 18.3, units = 'cm', res = 400, compression = 'lzw')
