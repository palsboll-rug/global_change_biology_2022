...
# Mutation rate to adjust the time
mu = 3.4E-7 # subst/site/generation from humans mitochondrial genome excluding control region accoridng to Ingman et al., 2000
