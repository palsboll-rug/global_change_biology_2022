...
setwd("[Add working directory here]/Correlations/Analysis/Theta_S/Approx_LR_1000")
...
# This will create a list of values from 0 to 30000 every 1000, which will be use as standard time intervals
...
filenameAllData="Southern_AllApprox_LR_1000.csv"
