...
setwd("[Add working directory here]/Correlations/Analysis/Theta_N/Approx_LR_1000")


library(readr)

folder <- "[Add root directory here]/Theta_N/"      # path to folder that holds multiple .csv files
