...
# This will create a list of values from 0 to 150000 every 2000, which will be use as standard time intervals
...
filenameAllData="Northern_AllApprox_LR_2000.csv"
