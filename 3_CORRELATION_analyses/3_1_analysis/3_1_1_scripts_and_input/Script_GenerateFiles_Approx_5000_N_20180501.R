...
setwd("[Add working directory here]/Correlations/Analysis/Theta_N/Approx_LR_5000")
...
# This will create a list of values from 0 to 150000 every 5000, which will be use as standard time intervals
...
filenameAllData="Northern_AllApprox_LR_5000.csv"
